...
//	String repoCloneUrlSsh;
	...
	protected String getRepoDesc() {
		return repoDesc;
	}
	protected void setRepoDesc(String repoDesc) {
		this.repoDesc = repoDesc;
	}
	protected String getRepoCloneUrl(String connString) {		
		return RepoCloneUrl.get(connString);
	}
	protected void setRepoCloneUrl(String connType,String repoCloneUrl) {
